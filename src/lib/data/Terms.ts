export const Terms = {
  PrivacyPolicy: `1. 개인정보의 처리 목적 <원데이>(‘https://www.oneday.com’이하 ‘원데이’) 은(는) 다음의 목적을 위하여 개인정보를 처리하고 있으며, 다음의 목적 이외의 용도로는 이용하지 않습니다.
    ...
    5. 개인정보의 파기<원데이>('원데이')은(는) 원칙적으로 개인정보 처리목적이 달성된 경우에는 지체없이 해당 개인정보를 파기합니다. 파기의 절차, 기한 및 방법은 다음과 같습니다.
    ...
    원데이 은 정보주체의 이용정보를 저장하고 수시로 불러오는 ‘쿠키’를 사용하지 않습니다.
    ...
    직책 :운영자
    직급 :운영자
    연락처 :010-0000-0000, puzzledpublic@gmail.com,
    ※ 개인정보 보호 담당부서로 연결됩니다.
    ...
    9. 개인정보의 안전성 확보 조치 <원데이>('원데이')은(는) 개인정보보호법 제29조에 따라 다음과 같이 안전성 확보에 필요한 기술적/관리적 및 물리적 조치를 하고 있습니다.
